...
export default function WhatsAppButton() {
  ...
  const whatsappNumber = "18578477814";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-30 flex flex-col items-end gap-3 sm:bottom-8 sm:right-8">
      {/* Tooltip */}
      <div
        className={`rounded-xl bg-white px-4 py-2.5 shadow-lg border border-border-light transition-all duration-300 origin-bottom-right ${
          hovered
      ...
      <a
        ...
        className="group relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl active:scale-95 sm:h-16 sm:w-16"
      >
        {/* Pulse ring */}
