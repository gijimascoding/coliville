...
import { properties, getPropertyBySlug, Property, Room } from "@/data/properties";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 sm:px-12 lg:px-24">
        ...
        <p className="mb-10 text-text-muted">
          {property.rooms.length} options available at {property.name}
        </p>
      ...
      <section className="bg-card-bg">
        <div className="mx-auto max-w-6xl px-6 py-16 sm:px-12 lg:px-24">
          ...
          <p className="mb-10 text-text-muted">
            Every room at {property.name} comes with these essentials
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            {property.amenities.map((amenity) => (
              <div
                key={amenity}
                className="flex items-center gap-3 rounded-xl border border-border-light bg-background px-4 py-3"
              >
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 sm:px-12 lg:px-24">
        ...
        <p className="mb-10 text-text-muted">
          Walk to everything you need from {property.name}
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {property.nearbyLandmarks.map((landmark) => (
            <div
              key={landmark}
              className="flex items-center gap-4 rounded-xl border border-border-light bg-card-bg px-5 py-4 transition-shadow hover:shadow-md"
            >
      ...
      <section className="bg-secondary">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 py-20 text-center sm:px-12 lg:px-24">
          ...
          <p className="max-w-md text-lg text-white/70">
            Join {property.name} and start living your best life in{" "}
            {property.neighborhood}.
          </p>
          ...
          <span className="inline-flex items-center gap-1.5">
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M3 7v4a1 1 0 001 1h16a1 1 0 001-1V7M3 12v5a1 1 0 001 1h1m14 0h1a1 1 0 001-1v-5M5 18v2m14-2v2M2 7h20M7 7V4a1 1 0 011-1h8a1 1 0 011 1v3"
              />
            </svg>
          ...
          <span className="inline-flex items-center gap-1.5">
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M4 12h16M4 12a2 2 0 01-2-2V6a4 4 0 014-4h1m13 10a2 2 0 002-2V8m-2 4v5a3 3 0 01-3 3H7a3 3 0 01-3-3v-5m4 8v2m8-2v2"
              />
            </svg>
        ...
        {room.features && room.features.length > 0 && (
          <div className="flex flex-wrap gap-1.5">
            {room.features.map((feature) => (
              <span
                key={feature}
                className="rounded-full bg-background px-2.5 py-0.5 text-xs font-medium text-text-secondary"
              >
                {feature}
              </span>
            ))}
